  ...
  return (
    <div className="">
      ...
      <div className="flex mt-6 gap-3">
        <div
          className="py-2 rounded-md flex-grow ring-gray-500 ring-2 text-sm text-center cursor-pointer"
        ...
        <div
          className="py-2 rounded-md flex-grow ring-red-600 ring-2 text-sm text-center cursor-pointer"
          style={{ userSelect: "none" }}
